...
@Component({
  ...
  template: `
    ...
    <form
      [class]="{'bg-red-100 border-red-500 p-4 mb-4': myNgForm?.controls?.['name']?.touched && myNgForm?.controls?.['name']?.invalid}"
      #myNgForm="ngForm"
    >
      ...
      <p
        ...
        *ngIf="myNgForm?.controls?.['name']?.touched && myNgForm?.controls?.['name']?.invalid"
      >
